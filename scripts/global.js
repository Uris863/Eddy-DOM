...
//abandoned part
function moveElement(elementID,final_x,fianl_y,interval) {
    ...
    var ypox = parseInt(elem.style.top);
    ...
    var repeat = "moveElement('"+elementID+"',"+final_x+","+fianl_y+","+interval+")";
